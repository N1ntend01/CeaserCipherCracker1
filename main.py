# Define the function that takes a string and returns a list of
# all the permutations of the string, shifting the positions of
  ...
  with open("output.txt", "w") as output_file:
    for shift in range(26):
      ...
      for char in ciphertext:
        if char.isalpha():
          new_char = chr((ord(char.lower()) - ord('a') + shift) % 26 +
                         ord('a'))
          if char.isupper():
